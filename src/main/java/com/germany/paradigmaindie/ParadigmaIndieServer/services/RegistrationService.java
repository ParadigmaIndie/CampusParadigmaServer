...
import com.germany.paradigmaindie.ParadigmaIndieServer.utils.EmailValidator;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) throws NotFoundException {

        if(!emailValidator.test(request.getEmail())){
            throw new IllegalStateException("email no valid");
        }

        String token = appUserDetailsService.signUpUser(new User(
                request.getUsername(),
                request.getPassword(),
                request.getEmail(),
